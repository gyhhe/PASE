...
def get_args():
    ...
    parser.add_argument('--backbone_weights_path', default='./data/weights/original_updown_backbone.pth',
                        type=str)
    parser.add_argument('--cross_warmup', default=8000, type=int, help='warmup iteration for instance-level interaction network')
    parser.add_argument('--dropout', default=0.2, type=float,
                        help='cross-modal interaction dropout rate')
